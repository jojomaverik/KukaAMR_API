...
async function subMission() {
  ...
  const payload = {
    ...
    robotIds:[robotId],
    missionData: [
      { sequence:1, position:pos1, type:"NODE_POINT", passStrategy:"AUTO", waitingMillis:2 },
      { sequence:2, position:pos2, type:"NODE_POINT", putDown:true, passStrategy:"AUTO", waitingMillis:2 }
    ]
  };
